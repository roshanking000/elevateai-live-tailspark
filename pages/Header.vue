    ...
    >
      ...
      >
        ...
        <a
          ...
          target="_blank"
          class="max-[767px]:ml-5 max-[991px]:mt-8 max-[991px]:ml-10 text-white text-center bg-[#472cb53d] border border-solid border-[#472cb5] px-6 font-semibold transition hover:bg-[#792CB524] hover:border-[#792cb5] inline-block py-5 rounded-2xl"
          >Unlimited Webflow Dev</a
        >
      </nav>
      <div
        class="max-[991px]:block max-[991px]:text-white max-[991px]:-mr-3 float-right cursor-pointer select-none hidden relative text-2xl p-3 lg:p-[18px]"
